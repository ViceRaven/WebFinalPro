...
/**
 * @template T
 * @typedef {import("../../WebFinalPro/Client/src/models/dataEnvelope").DataEnvelope} DataEnvelope
 * @typedef {import("../../WebFinalPro/Client/src/models/dataEnvelope").DataListEnvelope} DataListEnvelope
 */

/**
 * @typedef {import("../../WebFinalPro/Client/src/models/users").User} User
 */
