...
:::note
Type assertions are also commonly referred to as "type casting" in TypeScript. However, that term is technically slightly different from what is understood by type casting in other languages. Type assertions are a way to say to the TypeScript compiler, _"I know better than you, it's actually this different type!"_.
:::
...
Make sure to save this corrected file and then try redeploying your site.
